...
def juego():
    ...
    #------ENTRY PARA RESULTADOS----
    
    resul = StringVar()

    ety1 = CTkEntry(root,textvariable=resul,corner_radius=20,text_color='white',width=400,bg_color='black',
                         height=50,font=('Yamaka',40,'bold'),state='disable')
    
    ety1.place(relx=0.50,rely=0.76,anchor=CENTER)
    ...
    btn1 = CTkButton(frame1,text='PIEDRA',fg_color='#732425',hover_color='#3C2424',
                    ...
                    width=80,command=lambda:resultado(1))
    
    btn1.place(relx = 0.02,rely=0.9)

    btn2 = CTkButton(frame1,text='PAPEL',fg_color='#B8812D',hover_color='#8B6730',
                    font=('Impact',30),corner_radius=20,
                    width=100,command=lambda:resultado(2))
    
    btn2.place(relx = 0.35,rely=0.9)

    btn3 = CTkButton(frame1,text='TIJERA',fg_color='#91A03F',hover_color='#6A7534',
                    font=('Impact',30),corner_radius=20,
                    width=100,command=lambda:resultado(3))
    
    btn3.place(relx = 0.65,rely=0.9)    
